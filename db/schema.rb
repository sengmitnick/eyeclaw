...
ActiveRecord::Schema[7.2].define(version: 2026_03_02_090000) do
  ...
  create_table "bot_sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bot_id"], name: "index_bot_sessions_on_bot_id"
    t.index ["session_id"], name: "index_bot_sessions_on_session_id", unique: true
  end
  ...
  create_table "bots", force: :cascade do |t|
    ...
    t.index ["rokid_device_id", "rokid_user_id"], name: "index_bots_on_rokid_device_user", unique: true
